...
public class LanguageTextMeshTextMeshPro : MonoBehaviour
{
    [Header("Settings")]
    [SerializeField] private TMP_Text targetTextMesh; // Required TextMesh component.
    ...
    private void Size()
    {
        ...
        if (FontSize != 0)
        {
            targetTextMesh.fontSize = FontSize;
        }
    }
            ...
            if (idIndex >= 0)
            {
                ...
                if (id == value)
                {
                    ...
                    if (FontIndex >= 0)
                    {
                        ...
                        {
                            targetTextMesh.font = fontListObject.FontListTextMeshPro[Font - 1]; // Set the target text's font to the font at the specified index in the font list.
                        }
                    }
