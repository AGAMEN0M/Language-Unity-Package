...
public static class TextMeshProCanvas_Toggle_LT_Legacy
{
    [MenuItem("GameObject/Language/UI/Toggle (LT)")]
    public static void Create(MenuCommand menuCommand)
    {
        ...
        string prefabPath = "Assets/Language/Prefab/TextMesh Pro/UI/Toggle (LT).prefab";
