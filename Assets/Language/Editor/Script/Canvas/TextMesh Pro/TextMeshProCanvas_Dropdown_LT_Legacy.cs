...
public class TextMeshProCanvas_Dropdown_LT_Legacy : MonoBehaviour
{
    [MenuItem("GameObject/Language/UI/Dropdown (LT)")]
    public static void Create(MenuCommand menuCommand)
    {
        ...
        string prefabPath = "Assets/Language/Prefab/TextMesh Pro/UI/Dropdown (LT).prefab";
