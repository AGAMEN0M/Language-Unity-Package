...
public class TextMeshProCanvas_Button_LT_Legacy: MonoBehaviour
{
    [MenuItem("GameObject/Language/UI/Button (LT)")]
    public static void Create(MenuCommand menuCommand)
    {
        ...
        string prefabPath = "Assets/Language/Prefab/TextMesh Pro/UI/Button (LT).prefab";
