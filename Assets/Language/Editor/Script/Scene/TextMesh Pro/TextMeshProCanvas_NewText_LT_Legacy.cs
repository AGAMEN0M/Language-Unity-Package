...
public static class TextMeshProCanvas_NewText_LT_Legacy
{
    [MenuItem("GameObject/Language/Scene/Text (LT TMP)")]
    public static void Create(MenuCommand menuCommand)
    {
        // Manually added prefab path.
        string prefabPath = "Assets/Language/Prefab/TextMesh Pro/Scene/Text (LT TMP).prefab";
        ...
        newGameObject.name = "Text (LT TMP)";
