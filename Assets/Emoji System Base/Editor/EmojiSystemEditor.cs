...
namespace EmojiSystemBase.Editor
{
    /// <summary>
    ...
    public class EmojiSystemEditor : EditorWindow
    {
        ...
        /// <summary>
        /// Defines the type of emoji asset to be edited in the system.
        /// </summary>
        public enum Type
        {
            /// <summary>Uses Unity's legacy SpriteAsset system (UnityEngine.TextCore).</summary>
            Legacy,

            /// <summary>Uses TextMeshPro sprite assets (TMP_SpriteAsset).</summary>
            TextMeshPro
        }
        ...
        /// Automatically finds the folder "Emoji System Base/Editor Resources"
        /// anywhere in the project and loads the first Texture2D inside it as the icon.
        /// </summary>
        [MenuItem("Tools/Emoji System Editor")]
        public static void ShowWindow()
        {
            ...
            foreach (var guid in folderGuids)
            {
                ...
                // Ensure this is the correct path containing "Emoji System Base".
                if (!folderPath.Contains("Emoji System Base")) continue;
            ...
            Debug.LogWarning("Could not find 'Emoji System Base/Editor Resources' with a Texture2D inside.");
        }
        ...
        private void OnGUI()
        {
            ...
            if (showAssetEditor)
            {
                ...
                DrawSection("Sprite to Edit", true, true,
                    () =>
                    {
                ...
                DrawSection("Glyph Metrics Editor", true, HasValidSpriteAsset(), // Editable only if a valid asset is selected.
                    () =>
                    {
            ...
            if (showSpriteEditor)
            {
                DrawSection("Sprite Editor", true, true,
                    () =>
                    {
