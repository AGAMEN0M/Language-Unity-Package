...
public class ViewInformation : MonoBehaviour
{
    ...
    public float Height;
    public int Font;
    [SerializeField] private LanguageFontList fontListObject;
    ...
    [SerializeField] private int oldFontSize;
    ...
    private void Awake()
    {
        ...
        if (targetText.alignment == TextAnchor.MiddleLeft)
        {
            oldAlignment = 1;
        }
        else if (targetText.alignment == TextAnchor.MiddleCenter)
        {
            oldAlignment = 2;
        }
        else if (targetText.alignment == TextAnchor.MiddleRight)
        {
            oldAlignment = 3;
        }
    }
    ...
    private void Size()
    {
        ...
        if (Font != 0)
        {
            ...
            {
                targetText.font = fontListObject.FontList[Font - 1]; // Sets the text font based on the font list.
            }
        }
        else // Otherwise, keep the previous source.
        {
            targetText.font = fontListObject.FontList[0];
        }
