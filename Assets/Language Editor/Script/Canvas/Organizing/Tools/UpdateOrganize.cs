...
public class UpdateOrganize : MonoBehaviour
{
    ...
    void Organization()
    {
        ...
        LoadFile componenteLoadFile = FindObjectOfType<LoadFile>(); // Gets the current scene's LoadFile component.
        componenteLoadFile.Start(); // Calls the Start() method on the LoadFile component.
    }
