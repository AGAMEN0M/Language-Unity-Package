...
namespace LanguageTools.Editor
{
    public class ComponentConverter
    {
        ...
        /// </summary>
        [MenuItem("GameObject/Tools/Language Tool/Converter to Language Tool")]
        ...
        private static void ConvertTextComponent<T>(T uiComponent, Action logError) where T : Component
        {
