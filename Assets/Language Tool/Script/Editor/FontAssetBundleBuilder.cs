...
namespace LanguageTools.Editor
{
    ...
    public static class FontAssetBundleBuilder
    {
        ...
        /// <summary>
        /// Searches for Font and TMP_FontAsset assets inside the "Language Tool/AssetBundles" folder
        /// and creates individual asset bundles for each valid asset.
        /// </summary>
        [MenuItem("Assets/Tools/Language Tool/Build Font Asset Bundles")]
        public static void BuildFontAssetBundles()
        {
            // Attempt to locate the folder named "AssetBundles" in the project.
            var guids = AssetDatabase.FindAssets("AssetBundles t:Folder");
            if (guids.Length == 0)
            {
            ...
            foreach (var guid in guids)
            {
                ...
                // Ensure the folder is inside "Language Tool/AssetBundles".
                if (path.Contains("/Language Tool/AssetBundles"))
                {
                    folderPath = path;
                    break;
                }
            ...
            {
                Debug.LogError("Folder 'Language Tool/AssetBundles' not found.");
                return;
            }
