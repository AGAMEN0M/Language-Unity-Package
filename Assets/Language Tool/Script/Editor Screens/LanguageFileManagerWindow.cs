...
namespace LanguageTools.Editor
{
    public class LanguageFileManagerWindow : EditorWindow
    {
        ...
        [Tooltip("The language currently selected for editing in the dropdown.")]
        public string languageForEditing = "en";
        ...
        [Tooltip("List of languages that are available and detected from disk.")]
        public List<LanguageAvailable> availableLanguages = new();
        
        [Tooltip("Current scroll position for the window’s scroll view.")]
        public Vector2 scrollPosition = Vector2.zero;
        
        [Tooltip("Whether the window is being initialized for the first time.")]
        public bool firstTime = false;
        
        [Tooltip("Current index of the ID being edited or searched.")]
        public int idIndex;
        
        [Tooltip("Whether text component data should be displayed in the editor window.")]
        public bool showTextData = true;
        
        [Tooltip("Whether canvas component data should be displayed in the editor window.")]
        public bool showCanvasData = true;
        
        [Tooltip("Tracks whether the current data state has been saved to disk.")]
        public bool fileIsSaved = true;

        /// <summary>
        /// Path to the local file for storing language editing state.
        /// </summary>
        private const string fileData = "ProjectSettings/LanguageFileData.json";

        /// <summary>
        /// Root directory path for language TSV files.
        /// </summary>
        private string assetsPath;

        /// <summary>
        /// Full path to the canvas data TSV file.
        /// </summary>
        private string canvasDataFile;

        /// <summary>
        /// Full path to the language data TSV file.
        /// </summary>
        private string languageDataFile;

        /// <summary>
        /// Full path to the metadata TSV file.
        /// </summary>
        private string metaDataFile;

        /// <summary>
        /// Serialized representation of this EditorWindow for Unity’s property drawer system.
        /// </summary>
        private SerializedObject serializedObject;

        /// <summary>
        /// List of duplicate IDs found in the language components.
        /// </summary>
        private List<int> duplicateID = new();

        /// <summary>
        /// List of duplicate canvas IDs found in the canvas components.
        /// </summary>
        private List<int> canvasID = new();

        /// <summary>
        /// Display names of available cultures.
        /// </summary>
        private string[] cultureNames;

        /// <summary>
        /// Array of all CultureInfo supported by .NET.
        /// </summary>
        private CultureInfo[] cultures;

        /// <summary>
        /// Index of the currently selected culture in the dropdown.
        /// </summary>
        private int selectedCultureIndex;

        /// <summary>
        /// Cached trash icon used in UI for delete buttons.
        /// </summary>
        ...
        /// </summary>
        [MenuItem("Tools/Language Tool/Language File Manager")]
        ...
        private void DrawActionButtons()
        {
            BeginHorizontal();
            Space(20);
            DrawButton(new GUIContent("Open Folder", "Open the folder containing the language TSV files."), () => Application.OpenURL(assetsPath));
            Space(10);
            GUI.backgroundColor = fileIsSaved ? Color.white : Color.yellow; // Highlight the Save button if there are unsaved changes.
            DrawButton(new GUIContent("Save File", "Save the current language and canvas data to TSV files."), SaveLanguageFile);
            GUI.backgroundColor = Color.white; // Reset background color after drawing Save button.
            Space(10);
            DrawButton(new GUIContent("Load File", "Load the language and canvas data from TSV files."), LoadLanguageFile);
            GUILayout.FlexibleSpace();
            EndHorizontal();
            ...
            BeginHorizontal();
            Space(20);
            DrawButton(new GUIContent("Rebuild Canvas", "Rebuild the canvas by creating a new RebuildCanvas object."), () =>
            {
            ...
            Space(10);
            DrawButton(new GUIContent("Organize All Items", "Organize all language and canvas items (sort and compare IDs)."), () =>
            {
            ...
            Space(10);
            DrawButton(new GUIContent($"Search by ID: {idIndex}", "Search and highlight the component with the current ID."), () => SearchByID(idIndex));
            GUILayout.FlexibleSpace();
            EndHorizontal();
        }
        ...
        private void DrawButton(GUIContent label, Action action)
        {
