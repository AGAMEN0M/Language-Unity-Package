...
namespace LanguageTools.Editor
{
    public class LanguageIDScannerWindow : EditorWindow
    {
        ...
        /// <summary>
        /// Scroll position for result list.
        /// </summary>
        private Vector2 scrollPos;

        /// <summary>
        /// Dictionary that stores scene paths and their corresponding list of found Language IDs.
        /// </summary>
        private readonly Dictionary<string, List<LanguageIDInfo>> sceneLanguageIDs = new();

        /// <summary>
        /// Stores the path of the currently open scene to restore it after scanning.
        /// </summary>
        private string currentScenePath;

        /// <summary>
        /// Stores foldout (expanded/collapsed) state for each scene individually.
        /// </summary>
        private readonly Dictionary<string, bool> sceneFoldoutStates = new();

        /// <summary>
        /// Holds the user-input ID for individual searches.
        /// </summary>
        ...
        /// </summary>
        [MenuItem("Tools/Language Tool/Language ID Scanner")]
        ...
        private void OnGUI()
        {
            ...
            foreach (var kvp in sceneLanguageIDs)
            {
                ...
                sceneFoldoutStates[sceneName] = EditorGUILayout.Foldout(sceneFoldoutStates[sceneName], $"{sceneName} ({idList.Count} IDs found)", true);
        ...
        {
            /// <summary>The numeric ID associated with the component or list item.</summary>
            public int id;

            /// <summary>The type of component where the ID was found.</summary>
            public string componentType;

            /// <summary>The name of the GameObject that contains the component.</summary>
            public string objectName;

            /// <summary>The full hierarchy path of the GameObject in the scene.</summary>
            public string hierarchyPath;

            /// <summary>Indicates whether this ID appears more than once across scanned scenes.</summary>
