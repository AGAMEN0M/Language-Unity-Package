...
{
    [AddComponentMenu("Tools/Language Tool/3D Object/Language TextMesh (Legacy)")]
    public class LanguageTextMesh : MonoBehaviour
    {
        ...
        private LanguageSettingsData languageData;
    ...
    public class LanguageTextMeshEditor : UnityEditor.Editor
    {
