...
{
    [AddComponentMenu("Tools/Language Tool/3D Object/Language Audio Player")]
    public class LanguageAudioPlayer : MonoBehaviour
    {
        ...
        private string fileName = "Example.wav";
    ...
    public class LanguageAudioPlayerEditor : UnityEditor.Editor
    {
        /// <summary>
