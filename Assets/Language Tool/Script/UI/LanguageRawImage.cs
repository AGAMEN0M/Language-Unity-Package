...
{
    [AddComponentMenu("Tools/Language Tool/UI/Language Raw Image")]
    public class LanguageRawImage : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets or sets whether the RawImage component should be used.
        /// </summary>
        public bool UseRawImage
        {
            get => useRawImage;
            set => useRawImage = value;
        }

        /// <summary>
        /// Gets or sets the target RawImage component.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the loaded Texture2D.
        /// </summary>
    ...
    public class LanguageRawImageEditor : UnityEditor.Editor
    {
        /// <summary>
