...
{
    [ExecuteInEditMode]
    [AddComponentMenu("Tools/Language Tool/UI/Complements/Force Import Of Fonts (TMP)")]
    public class ForceImportOfFontsTMP : MonoBehaviour
    {
        ...
        #else
            Destroy(this); // Automatically remove this script at runtime.
        #endif
        }
    ...
    public class ForceImportOfFontsTMPEditor : UnityEditor.Editor
    {
