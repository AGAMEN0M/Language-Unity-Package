...
{
    [AddComponentMenu("Tools/Language Tool/UI/Language Image")]
    public class LanguageImage : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets or sets whether the Image component should be used.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the target Image component.
        /// </summary>
        public Image Image
        {
            get => image;
        ...
        /// <summary>
        /// Gets or sets the generated Sprite from the texture.
        /// </summary>
