...
namespace LanguageTools.TMP
{
    ...
    [AddComponentMenu("Tools/Language Tool/UI/TextMesh Pro/Adjust Size To Dropdown (TMP)")]
    public class AdjustSizeToDropdownTMP : MonoBehaviour
    {
        ...
        {
            /// <summary>Expands the element towards the left side.</summary>
            Left,

            /// <summary>Expands the element towards the right side.</summary>
            Right
        }
        ...
        private float manualSizeAdjustment;
        ...
        private FitDirection fitDirection = FitDirection.Right;
